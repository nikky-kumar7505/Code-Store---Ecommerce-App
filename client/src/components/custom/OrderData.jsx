            ...
            products.map((product) =>(
             <div key={product._id} className="flex flex-col sm:flex-row justify-between items-end sm:items-center border p-3 rounded-lg bg-gray-100 dark:bg-zinc-900">
                <div className="flex item items-center gap-2">
                    <img  src={product?.id?.image?.[0].url} alt={product?.id?.name} className="h-20 rounded-lg"/>
                    <div className="grid gap-1">
                        ...
                        <p className='flex text-xs sm:text-md gap-2  sm:gap-2 text-gray-500 my-2 sm:my-0'>
                            <span >
                                Color : <span style={{backgroundColor : product?.color }}> { product?.color } </span> 
                            </span>
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-center ">
            <span>
                ...
                <span className="capitalize" >
                    {new Date((createdAt).toLocalString())}
                </span> 
            </span>
